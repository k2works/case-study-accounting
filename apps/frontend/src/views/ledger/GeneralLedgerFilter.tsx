...
export const GeneralLedgerFilter: React.FC<GeneralLedgerFilterProps> = ({
  ...
  const handleChange =
    (field: keyof GeneralLedgerFilterValues) =>
    ...
    <div data-testid="general-ledger-filter">
      <div style={{ display: 'flex', flexWrap: 'wrap', gap: '16px', alignItems: 'flex-end' }}>
        <div style={{ minWidth: '220px' }}>
          <label htmlFor="general-ledger-filter-account">勘定科目</label>
          <select
            id="general-ledger-filter-account"
        ...
        <div>
          <label htmlFor="general-ledger-filter-date-from">期間（開始）</label>
          <input
            id="general-ledger-filter-date-from"
            type="date"
        ...
        <div>
          <label htmlFor="general-ledger-filter-date-to">期間（終了）</label>
          <input
            id="general-ledger-filter-date-to"
            type="date"
            value={values.dateTo}

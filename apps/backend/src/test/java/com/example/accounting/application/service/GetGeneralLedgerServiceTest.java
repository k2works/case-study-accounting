...
@DisplayName("GetGeneralLedgerService")
class GetGeneralLedgerServiceTest {
    ...
    private GetGeneralLedgerService service;

    @BeforeEach
    void setUp() {
        service = new GetGeneralLedgerService(accountRepository, journalEntryRepository);
    }
    ...
    class Execute {
        ...
        void shouldCalculateBalancesForDebitAccount() {
            ...
            GetGeneralLedgerQuery query = new GetGeneralLedgerQuery(1, dateFrom, dateTo, 0, 20);
        ...
        void shouldCalculateBalancesForCreditAccount() {
            ...
            GetGeneralLedgerQuery query = new GetGeneralLedgerQuery(2, dateFrom, dateTo, 0, 20);

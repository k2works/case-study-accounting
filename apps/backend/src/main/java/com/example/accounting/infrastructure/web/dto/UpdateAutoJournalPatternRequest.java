...
@Schema(description = "自動仕訳パターン更新リクエスト")
public record UpdateAutoJournalPatternRequest(
        @Schema(description = "パターン名", example = "売上計上（更新）", requiredMode = Schema.RequiredMode.REQUIRED)
        @NotBlank
        String patternName,
        ...
        @Schema(description = "説明", example = "売上データから自動仕訳を生成（更新）")
        String description,

        @Schema(description = "有効フラグ", example = "true", requiredMode = Schema.RequiredMode.REQUIRED)
        @NotNull
        Boolean isActive,
    ...
    public UpdateAutoJournalPatternRequest {

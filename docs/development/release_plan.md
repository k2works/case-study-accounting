...
gantt
    ...
    IT8 損益計算書              :active, a8, 2026-02-17, 14d
    リリース2.0 機能拡張版      :milestone, ma2, after a8, 0d
```
...
xychart-beta
    ...
    line "実績" [155, 137, 121, 103, 93, 76, 57, 44]
```
...
| 財務諸表計算の複雑性 | 高 | 段階的な実装とレビュー | ✅ 貸借対照表完了（IT-7）、損益計算書は IT-8 |

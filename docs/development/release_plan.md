...
xychart-beta
    ...
    line "実績" [155, 137, 121, 103, 93, 76, 57, 44, 36, 23, 13]
```
...
**フィーチャバッファ比率**: 28 / 155 = 18%（US-LDG-002 は IT-7、US-MST-005〜008 は IT-9、US-JNL-006/US-FS-003 は IT-10 で実装済み。残バッファ 5SP）

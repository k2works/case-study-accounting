...
gantt
    ...
    IT10 自動仕訳・財務分析       :active, a10, 2026-02-20, 14d
```
...
xychart-beta
    ...
    line "実績" [155, 137, 121, 103, 93, 76, 57, 44, 36, 23]
```
...
**フィーチャバッファ比率**: 28 / 155 = 18%（US-LDG-002 は IT-7、US-MST-005〜008 は IT-9 で実装済み。残バッファ 15SP）

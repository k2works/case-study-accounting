...
- [ ] US-FS-001 の全受入条件を満たしている
- [ ] US-LDG-002 の全受入条件を満たしている
...
|----------|---------|---------|------|------|
| FS-001-01 | 貸借対照表ユースケース設計 | 3h | Claude | [ ] |
| FS-001-02 | GetBalanceSheetQuery / Result 実装 | 3h | Codex | [ ] |
| FS-001-03 | GetBalanceSheetService 実装（カテゴリ集計ロジック） | 5h | Codex | [ ] |
| FS-001-04 | BalanceSheetRepository（Output Port）+ MyBatis mapper | 4h | Codex | [ ] |
| FS-001-05 | 前期比較ロジック実装 | 4h | Codex | [ ] |
| FS-001-06 | 貸借対照表 API 実装（GET /api/balance-sheet） | 3h | Codex | [ ] |
| FS-001-07 | 単体テスト作成 | 4h | Codex | [ ] |
| FS-001-08 | 貸借対照表画面 UI 実装（勘定式レイアウト） | 8h | Codex | [ ] |
| FS-001-09 | 前期比較 UI 実装 | 3h | Codex | [ ] |
| FS-001-10 | PDF/Excel ダウンロード機能実装 | 6h | Codex | [ ] |
| FS-001-11 | フロントエンド API 連携 | 2h | Codex | [ ] |
| FS-001-12 | 統合テスト（E2E テスト） | 3h | Claude | [ ] |
| | **小計** | **48h** | | |
...
| タスクID | タスク名 | 理想時間 | 担当 | 状態 |
|----------|---------|---------|------|------|
| LDG-002-01 | 補助元帳照会ユースケース設計 | 2h | Claude | [ ] |
| LDG-002-02 | GetSubsidiaryLedgerQuery / Result 実装 | 2h | Codex | [ ] |
| LDG-002-03 | GetSubsidiaryLedgerService 実装 | 4h | Codex | [ ] |
| LDG-002-04 | SubsidiaryLedgerRepository（Output Port）+ MyBatis mapper | 4h | Codex | [ ] |
| LDG-002-05 | 補助元帳 API 実装（GET /api/subsidiary-ledger） | 3h | Codex | [ ] |
| LDG-002-06 | 単体テスト作成 | 3h | Codex | [ ] |
| LDG-002-07 | 補助元帳照会画面 UI 実装 | 6h | Codex | [ ] |
| LDG-002-08 | フロントエンド API 連携 | 2h | Codex | [ ] |
| LDG-002-09 | 統合テスト（E2E テスト） | 2h | Claude | [ ] |
| | **小計** | **28h** | | |
...
|-------------|-------------|-----|------|--------|
| US-FS-001 | 貸借対照表表示 | 8 | 未着手 | - |
| US-LDG-002 | 補助元帳照会 | 5 | 未着手 | - |

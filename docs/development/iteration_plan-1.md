...
- [x] ユーザーIDとパスワードを入力してログインできる
- [x] 認証成功時、JWT トークンが発行される
- [x] 認証失敗時、エラーメッセージが表示される
- [x] 3回連続でログイン失敗した場合、アカウントがロックされる
...
- [x] ユーザーID、氏名、パスワード、ロールを入力して登録できる
- [x] ユーザーIDは一意である必要がある
- [x] パスワードは8文字以上で、英数字を含む必要がある
- [x] ロールは管理者、経理責任者、経理担当者、閲覧者から選択できる
...
- [x] 科目コード、科目名、勘定科目種別を入力して登録できる
- [x] 科目コードは一意である必要がある
- [x] 勘定科目種別は資産、負債、純資産、収益、費用から選択できる
- [x] 登録成功時、確認メッセージが表示される
...
- [イテレーション 1 ふりかえり](./retrospective-1.md) - KPT 分析と改善アクション

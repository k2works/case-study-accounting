...
|----------|---------|---------|------|------|
| AUTH-004-01 | ユーザー編集ユースケース設計 | 1h | - | 未着手 |
| AUTH-004-02 | UpdateUserCommand 実装 | 2h | - | 未着手 |
| AUTH-004-03 | UpdateUserService 実装 | 3h | - | 未着手 |
| AUTH-004-04 | ユーザー編集 API 実装（PUT /api/users/{id}） | 2h | - | 未着手 |
| AUTH-004-05 | 単体テスト作成 | 2h | - | 未着手 |
| AUTH-004-06 | ユーザー編集画面 UI 実装 | 4h | - | 未着手 |
| AUTH-004-07 | フロントエンド API 連携 | 2h | - | 未着手 |
| AUTH-004-08 | 統合テスト（E2E テスト） | 2h | - | 未着手 |
| | **小計** | **18h** | | |
...
| タスクID | タスク名 | 理想時間 | 担当 | 状態 |
|----------|---------|---------|------|------|
| AUTH-005-01 | ユーザー削除ユースケース設計 | 1h | - | 未着手 |
| AUTH-005-02 | DeleteUserCommand 実装 | 2h | - | 未着手 |
| AUTH-005-03 | DeleteUserService 実装 | 3h | - | 未着手 |
| AUTH-005-04 | ユーザー削除 API 実装（DELETE /api/users/{id}） | 2h | - | 未着手 |
| AUTH-005-05 | 単体テスト作成 | 2h | - | 未着手 |
| AUTH-005-06 | ユーザー削除確認ダイアログ UI 実装 | 2h | - | 未着手 |
| AUTH-005-07 | フロントエンド API 連携 | 2h | - | 未着手 |
| AUTH-005-08 | 統合テスト（E2E テスト） | 2h | - | 未着手 |
| | **小計** | **16h** | | |
...
| AUTH-006-07 | ユーザー一覧画面 UI 実装 | 6h | - | 未着手 |
| AUTH-006-08 | フィルタ・検索 UI 実装 | 3h | - | 未着手 |
| AUTH-006-09 | フロントエンド API 連携 | 2h | - | 未着手 |
...
|-------------|-------------|-----|------|--------|
| US-AUTH-004 | ユーザー編集 | 3 | 未着手 | - |
| US-AUTH-005 | ユーザー削除 | 3 | 未着手 | - |
| US-AUTH-006 | ユーザー一覧表示 | 5 | 未着手 | - |

...
| IT12-002 | SonarQube Quality Gate 最終確認 | 2 | 必須 | [x] |
| IT12-003 | E2E テスト安定性パターン標準化 | 1 | 重要 | [x] |
| IT12-004 | リリースノート v3.0 作成 | 1 | 必須 | [x] |
| IT12-005 | GitHub Milestone・Project 最終同期 | 1 | 必須 | [x] |
| IT12-006 | リリース完了チェックリスト運用 | 1 | 重要 | [x] |
| IT12-007 | ドキュメント最終整備 | 1 | 重要 | [x] |
| **合計** | | **10** | | |
...
| タスクID | タスク名 | 理想時間 | 担当 | 状態 |
|----------|---------|---------|------|------|
| IT12-002-01 | Backend SonarQube ダッシュボード確認 | 1h | Claude | [x] |
| IT12-002-02 | Frontend SonarQube ダッシュボード確認 | 1h | Claude | [x] |
| IT12-002-03 | Quality Gate 結果のスクリーンショット・記録 | 1h | Claude | [x] |
| IT12-002-04 | 指摘事項への対応（あれば） | 4h | Codex | [x] |
| | **小計** | **7h** | | |
...
| タスクID | タスク名 | 理想時間 | 担当 | 状態 |
|----------|---------|---------|------|------|
| IT12-003-01 | E2E テスト安定性ガイドライン作成 | 2h | Claude | [x] |
| | **小計** | **2h** | | |
...
| タスクID | タスク名 | 理想時間 | 担当 | 状態 |
|----------|---------|---------|------|------|
| IT12-004-01 | リリースノート v3.0 作成 | 2h | Claude | [x] |
| | **小計** | **2h** | | |
...
| タスクID | タスク名 | 理想時間 | 担当 | 状態 |
|----------|---------|---------|------|------|
| IT12-006-01 | リリース完了チェックリスト全項目確認 | 1h | Claude | [x] |
| | **小計** | **1h** | | |

**チェックリスト**:

- [x] 全 34 ストーリーの受入条件を満たしている
- [x] 全テスト（バックエンド + フロントエンド + E2E）がパス
- [x] SonarQube Quality Gate 確認完了
- [x] コードがコミット・プッシュ済み
- [x] ドキュメント（12 計画 + 11 ふりかえり + リリース計画）が最新
- [x] 全 GitHub Issue がクローズ済み
- [x] GitHub Project Board が同期済み（全 Done）
- [x] release_plan.md のベロシティ・バーンダウンが最終更新済み
- [x] docs/index.md と mkdocs.yml が最新
- [x] リリースノート v3.0 作成済み
- [x] GitHub Milestone「リリース 3.0 完成版」クローズ済み
...
| タスクID | タスク名 | 理想時間 | 担当 | 状態 |
|----------|---------|---------|------|------|
| IT12-007-01 | release_plan.md 最終更新（IT-12 実績反映） | 1h | Claude | [x] |
| IT12-007-02 | docs/index.md にイテレーション 12 情報追加 | 0.5h | Claude | [x] |
| IT12-007-03 | mkdocs.yml にイテレーション 12 ナビゲーション追加 | 0.5h | Claude | [x] |
| | **小計** | **2h** | | |
...
|---|-----------|-----------------|------|
| 1 | E2E テスト安定性パターンの標準化 | IT12-003 | [x] |
| 2 | SonarQube Quality Gate 最終確認 | IT12-002 | [x] |
| 3 | リリース完了チェックリスト運用 | IT12-006 | [x] |
...
- [x] SonarQube Quality Gate 確認完了（BLOCKER 脆弱性修正済み、ホットスポットレビュー要 UI 対応）
...
- [x] 全テスト（バックエンド + フロントエンド + E2E）がパス
- [x] SonarQube Quality Gate 確認完了（BLOCKER 修正済み、ホットスポット要 UI レビュー）
- [x] テストカバレッジ 80% 以上（LINE 95.4%, BRANCH 84.4%）
- [x] コードがコミット・プッシュ済み
- [x] 全ドキュメント（12 計画 + 11 ふりかえり + リリース計画）が最新
- [x] 全 GitHub Issue（34 件）がクローズ済み
- [x] GitHub Project Board 全アイテム Done（35/35）
- [x] 全 GitHub Milestone がクローズ済み（1.0, 2.0, 3.0）
- [x] release_plan.md のベロシティ・バーンダウンが最終更新済み
- [x] docs/index.md と mkdocs.yml が最新
- [x] リリースノート v1.0, v2.0, v3.0 作成済み
- [x] E2E テスト安定性ガイドライン作成済み（test_strategy.md セクション 12）
...
- [x] IT-12 のスコープ（品質保証・リリース準備）を理解した
- [x] タスク分解と見積もりに合意した
- [x] 10SP 相当を完了することにコミットする
- [x] 品質問題発見時は即座に対応する

### 完了の定義（Definition of Done）

- [x] すべてのテストがパスしている
- [x] SonarQube Quality Gate パス
- [x] リリース完了チェックリスト全項目クリア
- [x] GitHub の Milestone・Project が最終状態
- [x] ドキュメントが全て最新
...
| 2026-02-24 | IT12-002 完了（SonarQube 確認、BLOCKER 脆弱性修正、Quality Gate 結果記録） | Claude Opus 4.6 |
| 2026-02-24 | IT12-003 完了（E2E テスト安定性ガイドラインを test_strategy.md に追加） | Claude Opus 4.6 |
| 2026-02-24 | IT12-004 完了（リリースノート v3.0 作成） | Claude Opus 4.6 |
| 2026-02-24 | IT12-006 完了（リリース完了チェックリスト全項目確認、release_plan.md 最終更新） | Claude Opus 4.6 |
| 2026-02-24 | IT12-007 完了（release_plan.md IT-12 実績反映、docs/index.md・mkdocs.yml 更新、ふりかえり作成） | Claude Opus 4.6 |

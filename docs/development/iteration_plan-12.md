...
|----------|---------|--------|--------|------|
| IT12-001 | 統合テスト・リグレッションテスト | 3 | 必須 | [ ] |
...
- [ ] 全バックエンドテスト（単体 + 統合）がパス
- [ ] 全フロントエンドテスト（777+ テスト）がパス
- [ ] E2E テスト全件パス（CI 環境含む）
...
|----------|---------|---------|------|------|
| IT12-001-01 | バックエンド全テスト実行・結果確認 | 1h | Claude | [ ] |
| IT12-001-02 | フロントエンド全テスト実行・結果確認 | 1h | Claude | [ ] |
| IT12-001-03 | E2E テスト全件実行・結果確認 | 2h | Claude | [ ] |
| IT12-001-04 | クロス機能テスト（仕訳→承認→元帳→試算表→財務諸表） | 2h | Claude | [ ] |
| IT12-001-05 | 権限テスト（ADMIN/MANAGER/USER の各ロール） | 1h | Claude | [ ] |
| IT12-001-06 | データダウンロード機能の全形式確認 | 1h | Claude | [ ] |
| | **小計** | **8h** | | |

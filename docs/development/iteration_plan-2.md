...
|----------|---------|---------|------|------|
| MST-003-01 | 勘定科目削除ユースケース実装 | 2h | - | 未着手 |
| MST-003-02 | 使用中チェックロジック強化 | 2h | - | 未着手 |
| MST-003-03 | 勘定科目削除 API 実装 | 2h | - | 未着手 |
| MST-003-04 | 単体テスト作成 | 2h | - | 未着手 |
| MST-003-05 | 削除確認ダイアログ UI 実装 | 2h | - | 未着手 |
| MST-003-06 | フロントエンド API 連携 | 2h | - | 未着手 |
| MST-003-07 | 統合テスト | 2h | - | 未着手 |
| | **小計** | **14h** | | |
